...
var uristring =
  ...
  "mongodb://heroku_4l6gggzb:sccih7ajih6kp5rgnu19me1met@ds253713.mlab.com:53713/heroku_4l6gggzb";
...
// Creating more users manually
var jonnyO = new PUser({
  name: { first: "Jonny", last: "O" },
  age: 33
});
jonnyO.save(function(err) {
  if (err) console.log("Error on save!");
});
...
var html1 =
  '<title> hello-mongoose: MongoLab MongoDB Mongoose Node.js Demo on Heroku </title> \
<head> \
...
var html4 =
  '<h2> Queried (name.last = "Doe", age >64) Documents in MonogoDB database </h2> <pre><code> ';
